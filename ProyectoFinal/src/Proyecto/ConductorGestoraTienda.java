...
public class ConductorGestoraTienda{
	...
	public static void main(String[] args) throws ExcepcionTrabajador{
		...
		try
		{
			...
			Producto [] producto={new Producto("Tarjeta de red",15.05,fecha1,8,0.3),new Producto("Disco CD",1.20,fecha2,9,0.1),
			...
			System.out.println(GestoraTienda.CalculaVenta(producto, fechaIni, fechaFin));
			//System.out.println(GestoraTienda.ExisteProducto(producto, nombre));
			//nombre="usb 3.0";
			//System.out.println(GestoraTienda.ExisteProducto(producto, nombre));
			//System.out.println(GestoraTienda.ContrataTrabajador(tarbajador));
